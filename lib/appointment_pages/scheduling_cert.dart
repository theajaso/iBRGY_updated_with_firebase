...
import 'package:ibrgy/appointment_pages/confirm_cert.dart';
import 'package:ibrgy/appointment_pages/confirm_cert2.dart';
import 'package:intl/intl.dart';

class SchedulingCert extends StatefulWidget {
  final String selectedCertificateType;
  final String fullName;
  final String address;
  final String purpose;

  const SchedulingCert({
    Key? key,
  ...
  @override
  _SchedulingCertState createState() => _SchedulingCertState();
}

class _SchedulingCertState extends State<SchedulingCert> {
  ...
  void _navigateToDisplayDatePage(BuildContext context) async {
    if (widget.selectedCertificateType == "Building Permit" ||
        widget.selectedCertificateType == "Excavation Permit") {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CertDatePage2(
            requestDate: requestDate,
            selectedCertificateType: widget.selectedCertificateType,
          ),
        ),
      );
    } else {
  ...
  Future<void> _storeDataToFirestore() async {
    ...
    if (user != null) {
      ...
      await appointmentsCollection.add({
        ...
        'certificateType': widget.selectedCertificateType,
