...
class BussCertDatePage extends StatelessWidget {
  final DateTime? requestDate;

  const BussCertDatePage({Key? key, required this.requestDate})
      : super(key: key);
          ...
          child: Form(
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'Please bring your DTI Business Registration/Sec Registration upon claiming your requested document.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.normal,
