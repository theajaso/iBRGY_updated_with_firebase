...
class SchedulingBuss extends StatefulWidget {
  final String fName;
  final String address;
  final String businessName;
  final String businessType;

  const SchedulingBuss({
    Key? key,
    required this.fName,
...
class _SchedulingState extends State<SchedulingBuss> {
  ...
  Future<void> _navigateToDisplayDatePage(BuildContext context) async {
    ...
    if (user != null) {
      ...
      await appointmentsCollection.add({
        ...
        'certificateType': widget.businessType,
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => BussCertDatePage(requestDate: requestDate),
        ),
      );
    }
  }
